...
export const startSimulation = (courseId, botCount, nickname, totalSeats, remainingSeats, queueToken) =>
  api.post('/simulation/start', { courseId, botCount, nickname, totalSeats, remainingSeats, queueToken }).then(r => r.data.data)
